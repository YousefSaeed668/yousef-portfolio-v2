  ...
  return (
    <article className="group relative grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
      ...
      >
        ...
        <Link
          href={`/projects/${slug}`}
          className={`${reverse ? "" : "self-start "}text-white border border-white/20 rounded-full px-8 py-3 text-sm font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-all`}
        >
          View Project
        </Link>
      </div>
